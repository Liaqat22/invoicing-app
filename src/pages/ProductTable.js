...
function ProductTable({dataGet , getProfile}) {
    ...
    <Table aria-label="payment info table">
      ...
      <TableBody>
        <TableRow>
          ...
          <TableCell align="right">{getProfile?.easypaisa || "Null"}</TableCell>
        </TableRow>
        <TableRow>
          <TableCell>Jazzcash</TableCell>
          <TableCell align="right">{getProfile?.jazzcash || "Null"}</TableCell>
        </TableRow>
